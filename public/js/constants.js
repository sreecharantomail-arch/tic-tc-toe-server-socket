...
// -------------------------------------------------------------------
const THEMES = [
  { id: 'dark',  label: 'Dark Neon',  bg: '#0a0a1a', accent1: '#00f5ff', accent2: '#ff2d78', cost: 0 },
  { id: 'light', label: 'Light Mode', bg: '#f0f4ff', accent1: '#0066ff', accent2: '#ff2d78', cost: 0 },
  { id: 'cyber', label: 'Cyberpunk',  bg: '#000800', accent1: '#00ff44', accent2: '#ff6600', cost: 200 },
  { id: 'ocean', label: 'Deep Ocean', bg: '#000d1a', accent1: '#00aaff', accent2: '#ff6688', cost: 300 },
  { id: 'fire',  label: 'Inferno',    bg: '#1a0500', accent1: '#ff6600', accent2: '#ff2244', cost: 400 },
  { id: 'mint',  label: 'Neon Mint',  bg: '#001a10', accent1: '#00ffaa', accent2: '#ff44aa', cost: 350 },
  {
    id: 'royalgold',
    label: '👑 Royal Gold',
    bg: '#0b0b0b',
...
const NPC_NAMES = [
  ...
  'Casey', 'Riley', 'Quinn', 'Nova', 'Ash',
  'Sky', 'River', 'Blake', 'Drew', 'Avery',
];
...
const OPPONENT_CHAT_RESPONSES = [
  'Nice!', 'Hmm 🤔', "Let's go!", 'GG!',
  'Watch out 👀', 'Ez game 😏', 'Oops 😅',
  "You're good!", '🔥🔥', 'gg wp',
];